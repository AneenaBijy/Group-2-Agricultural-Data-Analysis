...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    ViewPager viewPager;
    TabLayout tabLayout;
    TextView lastcity,lasttemp,lastpressure,lasthumid,lastwind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lastcity = (TextView) findViewById(R.id.lastcity);
        lasttemp = (TextView) findViewById(R.id.lasttemp);
        lastpressure = (TextView) findViewById(R.id.lastpressure);
        lasthumid = (TextView) findViewById(R.id.lasthumid);
        lastwind = (TextView) findViewById(R.id.lastwind);
...
//  final SharedPreferences finalPrefs = prefs;
        save.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                Bundle b = new Bundle();
                b.putString("city1",lastcity.getText().toString());
                b.putString("desc1",todayDescription.getText().toString());
                b.putString("temp1",todayTemperature.getText().toString());
                b.putString("wind1",todayWind.getText().toString());
                b.putString("pressure1",todayPressure.getText().toString());
                b.putString("humidity1",todayHumidity.getText().toString());
                intent.putExtras(b);
    ...
    private void updateTodayWeatherUI() {
        ...
        lasttemp.setText(new DecimalFormat("0.#").format(temperature) + " " + sp.getString("unit", "°C"));
        todayDescription.setText(todayWeather.getDescription().substring(0, 1).toUpperCase() +
                todayWeather.getDescription().substring(1) + rainString);

        lastcity.setText(todayWeather.getCity().substring(0, 1).toUpperCase() +
                todayWeather.getCity().substring(1) + rainString);
   ...
   /* if (currentPage == 0 && longTermTodayWeather.isEmpty()) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
       ...
       /* db.execSQL("INSERT INTO weather VALUES('"+todayDescription.getText()+"','"+todayTemperature.getText()+
                "','"+todayWind.getText()+"','"+todayHumidity.getText()+"');");
        ...
        if (id == R.id.action_view) {
            ...
            while(c.moveToNext())
            {
                ...
                buffer.append("Temperature: "+c.getString(1)+"\n");
                buffer.append("Pressure: "+c.getString(2)+"\n\n");
                buffer.append("Humidity: "+c.getString(3)+"\n\n");
                buffer.append("wind: "+c.getString(4)+"\n\n");
            }
